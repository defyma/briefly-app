...
- `CHAT_KEEP_RECENT` is how many newest conversation messages stay intact after compaction
- auto compaction stays in the same thread and inserts an `------ auto compacting -------` summary block generated by the agent
